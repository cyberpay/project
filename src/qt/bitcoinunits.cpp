...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("ERY");
    case mBTC: return QString("mERY");
    case uBTC: return QString::fromUtf8("μERY");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("Erylliums"));
    case mBTC: return QString(QObject::tr("Milli-Erylliums (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-Erylliums (1 / 1,000,000)"));
    default: return QString("???");
    }
}
