...
const string strMessageMagic = "Eryllium Signed Message:\n";
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("Eryllium-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Eryllium
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // Eryllium: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Eryllium", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "ERY genesis block";
        CTransaction txNew;
        ...
        block.nNonce   = 1076429; // !fTestNet ? 1575379 : 46534;
		
        block.print();

        //// debug print
        assert(block.hashMerkleRoot == uint256("0xa0052bdf4d5f83b450f48586a4781912eecf7081ab72ec33dea72f48f1293abf"));
...
unsigned char pchMessageStart[4] = { 0xb8, 0xfe, 0xe2, 0xe5 };
